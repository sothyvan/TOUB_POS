...
function mapReportOrder(order) {
  ...
  return {
    ...
    total_khr: Number(order.total_khr || 0),
    subtotal_khr: Number(order.subtotal_khr || 0),
    pricing_currency: order.pricing_currency,
    exchange_rate_khr_per_usd: Number(order.exchange_rate_khr_per_usd || 4100),
    cash_received_usd: order.cash_received_usd,
    cash_received_khr: order.cash_received_khr,
    change_due_usd: order.change_due_usd,
    change_due_khr: order.change_due_khr,
    change_currency: order.change_currency,
